...
STATIC const mp_rom_map_elem_t lte_locals_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_imei),                MP_ROM_PTR(&lte_imei_obj) },
    { MP_ROM_QSTR(MP_QSTR_iccid),               MP_ROM_PTR(&lte_iccid_obj) },
    { MP_ROM_QSTR(MP_QSTR_send_at_cmd),         MP_ROM_PTR(&lte_send_raw_at_obj) },
    { MP_ROM_QSTR(MP_QSTR_reset),               MP_ROM_PTR(&lte_reset_obj) },
	{ MP_ROM_QSTR(MP_QSTR_modem_upgrade_mode),  MP_ROM_PTR(&lte_upgrade_mode_obj) },
